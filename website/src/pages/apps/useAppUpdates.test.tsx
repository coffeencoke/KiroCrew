...
describe('useAppUpdates — Update All', () => {
  ...
  it('opens the first app needing consent after Update All', async () => {
    apiUpdateApp
  ...
  it('still opens consent after a mixed Update All result', async () => {
    apiUpdateApp
    ...
    expect(updateAppNav).toHaveBeenCalledExactlyOnceWith('docs')
    expect(setSuccess).not.toHaveBeenCalled()
  })
