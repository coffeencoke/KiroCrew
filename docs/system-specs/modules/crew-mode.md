...
changes the backend without supplying a model also clears the saved model and
inherited effort pin.
...
changing member defaults while a run is queued does not supply a new effort.
