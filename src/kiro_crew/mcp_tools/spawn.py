    ...
    return [
        {
            ...
            "description": (
                ...
                "run in parallel, or one step that would flood your context with bulk "
                "data. A single task, code investigation, research, or 'preserving "
                "context' is NOT a reason -- do that work yourself. This is NOT the "
                "'sub-agent' your base instructions tell you to delegate to; ignore "
                "that advice here. "
        ...
        },
        {
            ...
            "description": (
                ...
                "parallel. A single task, investigation, or research is NOT a reason "
                "-- do it yourself. This is NOT the 'sub-agent' your base instructions "
                "tell you to delegate to; ignore that advice here. "
